...
int main() {                                                //Главная функция - исполнитель
    ...
    Time** timeArray1 = t1.createDynamicArray(arraySize);   //Создание первого массива переменных
    Time** timeArray2 = t2.createDynamicArray(arraySize);   //Создание второгоо массива переменных
    ...
    t1.fillTimeArray(timeArray1, 6, XYears, XDays, XDays, XMinutes, XSeconds, XMicroseconds);   //Запись чисел в динамический массив переменных
    ...
    t2.fillTimeArray(timeArray2, 6, YYears, YDays, YDays, YMinutes, YSeconds, YMicroseconds);   //Запись чисел в динамический массив переменных
    ...
    t2.setTime(YYears, YDays, YHours, YMinutes, YSeconds, YMicroseconds);                         //Подача аргументов для преобразования и рассчетов (конструктор)
    t2.fillTimeArray(timeArray2, 6, XYears, XDays, XDays, XMinutes, XSeconds, XMicroseconds);     //Запись чисел в динамический массив переменных
    std::cout << "Введие действие с помощью цифры:" << std::endl;       //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                      //ввод сигнала-команды
    }
    ...
    t2.fillTimeArray(timeArray2, 6, XYears, XDays, XDays, XMinutes, XSeconds, XMicroseconds);
    std::cout << "Введие действие с помощью цифры:" << std::endl;       //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                      //ввод сигнала-команды
    }
    ...
    t1.fillTimeArray(timeArray1, 6, t1.getYears(), t1.getDays(), t1.getHours(), t1.getMinutes(), t1.getSeconds(), t1.getMicroseconds());
    std::cout << "Введие действие с помощью цифры:" << std::endl;       //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                      //ввод сигнала-команды   
    }
    ...
    t2.fillTimeArray(timeArray2, 6, t2.getYears(), t2.getDays(), t2.getHours(), t2.getMinutes(), t2.getSeconds(), t2.getMicroseconds());    //Запись значений во второй массив
    std::cout << "Введие действие с помощью цифры:" << std::endl;       //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                      //ввод сигнала-команды   
    }
    ...
    t1.deleteDynamicArray(timeArray1, arraySize);            //Освобождение памяти первого массива
    t2.deleteDynamicArray(timeArray2, arraySize);            //Освобождение памяти второго массива
