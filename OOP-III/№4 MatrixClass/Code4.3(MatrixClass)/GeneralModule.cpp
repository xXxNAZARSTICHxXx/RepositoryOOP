///Ст  ич Назар Иванович ИВТ-22 (КЛАССЫ)
...
do{                                                                                                 //Цикл с постусловием
    ...
    if (contr==27)                                                                                  //Если подался сигнал 26
    {
    int i;
    std::cout << "Введите число для сложения:" << std::endl; 
    std::cin >> i;
    myMatrixFIRST.AddScalar(i);                                                                     //Сложение матрицы на число - первая
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }

    if (contr==28)                                                                                  //Если подался сигнал 26
    {
    int i;
    std::cout << "Введите число для сложения:" << std::endl; 
    std::cin >> i;
    myMatrixSECOND.AddScalar(i);                                                                    //Сложение матрицы на число - вторая
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }

    if (contr==29)                                                                                  //Если подался сигнал 26
    {
    int i;
    std::cout << "Введите число для вычитания:" << std::endl; 
    std::cin >> i;
    myMatrixFIRST.SubtractScalar(i);                                                                //Вычитание числа из матрицы - первая
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }

    if (contr==30)                                                                                  //Если подался сигнал 26
    {
    int i;
    std::cout << "Введите число для вычитания:" << std::endl; 
    std::cin >> i;
    myMatrixSECOND.SubtractScalar(i);                                                               //Вычитание числа из матрицы - вторая
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }

    if (contr==31)                                                                                  //Если подался сигнал 26
    {
    myMatrixFIRST.invertMatrix();                                                            
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }

    if (contr==32)                                                                                  //Если подался сигнал 26
    {
    myMatrixSECOND.invertMatrix();                                                           
    std::cout << "Введие действие с помощью цифры:" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
    std::cin >> contr;                                                                              //Ввод сигнала-команды     
    }
    ...
    if (contr==0)                                                                                   //Если подался сигнал 0 (начальный сигнал для запуска цикла)
    {
        ...
        std::cout << "27:Сложение числа в ПЕРВОЙ матрице" << std::endl;                                             //Вывод строки"27:Сложение числа в ПЕРВОЙ матрице"
        std::cout << "28:Сложение числа во ВТОРОЙ матрице" << std::endl;                                            //Вывод строки"28:Сложение числа во ВТОРОЙ матрице"
        std::cout << "29:Вычитание из ПЕРВОЙ матрицы числа" << std::endl;                                           //Вывод строки"29:Вычитание из ПЕРВОЙ матрицы числа"
        std::cout << "30:Вычитание из ВТОРОЙ матрицы числа" << std::endl;                                           //Вывод строки"30:Вычитание из ВТОРОЙ матрицы числа"
        std::cout << "31:Поиск ПЕРВОЙ обратной матрицы" << std::endl;                                               //Вывод строки"31:Поиск ПЕРВОЙ обратной матрицы"
        std::cout << "32:Поиск ВТОРОЙ обратной матрицы" << std::endl;                                               //Вывод строки"32:Поиск ВТОРОЙ обратной матрицы"
        std::cout << "33:Выйти из программы" << std::endl;                                                          //Вывод строки"33:Выйти из программы"                                     
        ...
        if (contr>33 || contr<0)
        {
            std::cout << "Этого числа нет в списке!" << std::endl;                                   //Вывод строки "Введие действие с помощью цифры:"
            std::cout << "Введие действие с помощью цифры:" << std::endl;                                               //Вывод строки"Введие действие с помощью цифры:"
            std::cin >> contr;                                                                              //Ввод сигнала-команды 
        }

    } while (contr!=33);                                                                            //Если подался сигнал 27
