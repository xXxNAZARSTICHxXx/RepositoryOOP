...
public:                                             //Открытая зона объявлений
    ...
    Time** createDynamicArray(int size);            ///Функция создания ВРЕМЯННОГО массива 
    void deleteDynamicArray(Time** timeArray, int size);                            ///Функция удаления ВРЕМЯННОГО массива                                                                           
    void fillTimeArray(Time** timeArray, int size, long years, short days, int hours, int minutes, long seconds, short microseconds);   ///Функция записи значений в массив 
